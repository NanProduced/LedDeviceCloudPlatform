...
import org.nan.gateway.filter.RemoveJwtFilter;
import org.nan.gateway.handler.AccessDeniedHandler;
import org.nan.gateway.handler.AuthenticationEntryPoint;
...
public class ResourceServerConfig {
    ...
    public Converter<Jwt, ? extends Mono<? extends AbstractAuthenticationToken>> jwtAuthenticationConverter() {
        ...
        jwtAuthenticationConverter.setPrincipalClaimName("uid");
