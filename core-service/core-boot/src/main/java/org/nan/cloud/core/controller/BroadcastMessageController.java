...
public class BroadcastMessageController implements BroadcastMessageApi {
    ...
    @Override
    @Operation(summary = "获取用户广播消息列表", description = "分页查询当前用户的广播消息，支持类型筛选和已读状态筛选")
